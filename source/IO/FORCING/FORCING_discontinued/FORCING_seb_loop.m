...
%             end
        ...
        function forcing = param_file_info(forcing)
            ...
            forcing.PARA.comment.number_of_years = {'number of years from the start time'};

            forcing.PARA.comment.number_of_iterations = {'number of iterations of the selected model period'};
            forcing.PARA.comment.real_time_iteration_number = {'iteration for which the timestamp from the forcing file is used'};
