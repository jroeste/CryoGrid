...
classdef FORCING_slope_seb_topoScale_slice_ensemble < FORCING_slope_seb_topoScale_slice
    ...
    methods
        ...
        function forcing = provide_PARA(forcing)         
            ...
            forcing = provide_PARA@FORCING_slope_seb_topoScale_slice(forcing);
        ...
        function forcing = finalize_init(forcing, tile)
            forcing = finalize_init@FORCING_slope_seb_topoScale_slice(forcing, tile);
        ...
        function forcing = interpolate_forcing(forcing, tile)
            forcing = interpolate_forcing@FORCING_slope_seb_topoScale_slice(forcing, tile);
