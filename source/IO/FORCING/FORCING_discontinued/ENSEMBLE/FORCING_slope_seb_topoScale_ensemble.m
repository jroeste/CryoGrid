...
classdef FORCING_slope_seb_topoScale_ensemble < FORCING_slope_seb_topoScale
    ...
    methods
        ...
        function forcing = provide_PARA(forcing)         
            ...
            forcing = provide_PARA@FORCING_slope_seb_topoScale(forcing);
        ...
        function forcing = finalize_init(forcing, tile)
            forcing = finalize_init@FORCING_slope_seb_topoScale(forcing, tile);
        ...
        function forcing = interpolate_forcing(forcing, tile)
            forcing = interpolate_forcing@FORCING_slope_seb_topoScale(forcing, tile);
