...
classdef FORCING_seb_mat_ensemble < FORCING_seb_mat
    ...
    methods
        ...
        function forcing = provide_PARA(forcing)         
            ...
            forcing = provide_PARA@FORCING_seb_mat(forcing);
        ...
        function forcing = finalize_init(forcing, tile)
            forcing = finalize_init@FORCING_seb_mat(forcing, tile);
        ...
        function forcing = interpolate_forcing(forcing, tile)
            forcing = interpolate_forcing@FORCING_seb_mat(forcing, tile);
