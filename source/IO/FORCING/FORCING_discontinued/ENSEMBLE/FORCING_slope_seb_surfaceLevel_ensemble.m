...
classdef FORCING_slope_seb_surfaceLevel_ensemble < FORCING_slope_seb_surfaceLevel
    ...
    methods
        ...
        function forcing = provide_PARA(forcing)         
            ...
            forcing = provide_PARA@FORCING_slope_seb_surfaceLevel(forcing);
        ...
        function forcing = finalize_init(forcing, tile)
            forcing = finalize_init@FORCING_slope_seb_surfaceLevel(forcing, tile);
        ...
        function forcing = interpolate_forcing(forcing, tile)
            forcing = interpolate_forcing@FORCING_slope_seb_surfaceLevel(forcing, tile);
