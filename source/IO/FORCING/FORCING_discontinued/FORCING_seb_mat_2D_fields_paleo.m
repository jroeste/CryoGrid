...
classdef FORCING_seb_mat_2D_fields_paleo < FORCING_base & READ_FORCING_mat
    ...
    methods
        ...
        function forcing = finalize_init(forcing, tile)
            ...
            variables = {'precip'; 'Tair'; 'Lin'; 'Sin'; 'RH'; 'wind'; 'latitude'; 'longitude'; 'year'; 'month'};
            ...
            variables = {'precip'; 'Tair'; 'Lin'; 'Sin'; 'RH'; 'wind'};
