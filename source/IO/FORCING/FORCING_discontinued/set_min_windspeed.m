...
classdef set_min_windspeed < FORCING_base 
    ...
    methods
        ...
        function forcing = post_process(post_proc, forcing, tile)
                ...
                forcing.DATA.wind(forcing.DATA.wind < post_proc.PARA.min_windspeed) = post_proc.PARA.min_windspeed + forcing.DATA.wind(forcing.DATA.wind < post_proc.PARA.min_windspeed).*0;
