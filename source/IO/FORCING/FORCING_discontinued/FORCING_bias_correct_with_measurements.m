...
classdef FORCING_bias_correct_with_measurements < FORCING_base_discontinued % & READ_FORCING_mat
...
%             altitude formula) if not provided by the forcing time series
        ...
        function forcing = interpolate_forcing(forcing, tile)
            forcing = interpolate_forcing@FORCING_base_discontinued(forcing, tile);
