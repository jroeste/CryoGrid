...
classdef FORCING_seb_topoScale_slice < FORCING_base 
    ...
    methods
        ...
        function forcing = finalize_init(forcing, tile)
            ...
            proc_functions = {'set_start_end_time_nc'; 'read_nc_pressure_levels'; 'process_topoScale'; 'split_precip_snow_rain'; 'assign_lb_heatflux_airT_height'; 'scale_precip'; 'check_and_correct'};
...
%             forcing.TEMP.snowfall = double(forcing.TEMP.Tair <= 2) .* forcing.TEMP.snowfall;
            ...
            if tile.t > forcing.DATA.timeForcing(end,1)-2 && forcing.DATA.timeForcing(end,1) < forcing.PARA.end_time
                ...
                proc_functions = {'advance_time_slice_nc'; 'read_nc_pressure_levels'; 'process_topoScale'; 'split_precip_snow_rain'; 'scale_precip'; 'check_and_correct'};
                for i=1:size(proc_functions,1)
                    proc = str2func(proc_functions{i,1});
                    proc = proc();
                    proc.PARA = forcing.PARA;
