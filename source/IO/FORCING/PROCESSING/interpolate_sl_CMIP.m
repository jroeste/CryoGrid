...
classdef interpolate_sl_CMIP < matlab.mixin.Copyable 
    ...
    methods
        ...
        function forcing = process(proc, forcing, tile)
            ...
            data = forcing.DATA;
            time = forcing.DATA.timeForcing;
            forcing.DATA=[];
            forcing.DATA.timeForcing = time;
            variables = {'precip'; 'Tair'; 'Lin'; 'Sin'; 'S_TOA'; 'q'; 'wind'; 'p'};
