...
classdef calculate_RH_from_q < matlab.mixin.Copyable %makes the TRANSFORM object
    ...
    methods
        ...
        function forcing = process(proc, forcing, tile)
            ...
            forcing.DATA.RH = forcing.DATA.q .* forcing.DATA.p ./0.622 ./ 611.2 ./ (double(forcing.DATA.Tair>=0) .* exp(17.62 .* forcing.DATA.Tair ./ (243.12+forcing.DATA.Tair)) + ...
