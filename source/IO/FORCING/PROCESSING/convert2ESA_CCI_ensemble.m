%========================================================================
% CryoGrid FORCING processing class convert2ESA_CCI_ensemble
%
...
classdef convert2ESA_CCI_ensemble <  matlab.mixin.Copyable 
    ...
    methods
        function proc = provide_PARA(proc)
            ...
            proc.PARA.degree_day_factor=0.2/1e2.* 3.34e8 ./ (24.*3600); % Restricted degree day factor (m*degC/day , value from Burbaker et al. 1996)
        end
