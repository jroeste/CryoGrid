classdef doy_rel_average < matlab.mixin.Copyable
    ...
    methods
        ...
        function forcing_corrected = bias_correct(bias_correct, reference_class, tile)
            ...
            for i=1:365
                ...
                offset_factor = mean(overlap_pairs(range,1)) ./ mean(overlap_pairs(range,2));
                offset_factor(isinf(offset_factor)) = 1;
                offset_factor(isnan(offset_factor)) = 1;
