%========================================================================
% CryoGrid GROUND class GROUND_freezeC_RichardsEqW_seb_pressure_snow
...
%         function ground = GROUND_freezeC_RichardsEqW_seb_pressure_snow(index, pprovider, cprovider, forcing)
%             ground@GROUND_freezeC_RichardsEqW_seb_pressure(index, pprovider, cprovider, forcing);
%         end
