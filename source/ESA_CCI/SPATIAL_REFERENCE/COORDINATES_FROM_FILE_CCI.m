...
classdef COORDINATES_FROM_FILE_CCI < matlab.mixin.Copyable
    ...
    methods
        ...
        function proj = finalize_init(proj)
            ...
            proj.STATVAR.mask = logical(proj.STATVAR.longitude.*0+1);
            proj.STATVAR.mask(proj.STATVAR.latitude>90 | proj.STATVAR.latitude <-90 | proj.STATVAR.longitude >180 | proj.STATVAR.longitude < -180,1) = 0;
