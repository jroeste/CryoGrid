...
classdef FREEZE_CURVE_Painter < BASE
...
%             porosity_min = 0.05;
%             
%             beta_interface = 1./3;  %make this a constant!
%             
...
% %             gamma_right = T_nonlinear.* 0 + 1 + depth_gamma_LUT.^(depth_gamma_LUT-1);
%             
%             
