...
classdef GROUND_freezeC_RichardsEqW_Xice_seb_snow_BGC < GROUND_freezeC_RichardsEqW_Xice_seb_snow
    ...
    methods
        ...
        function ground = finalize_init(ground, tile) 
            ...
            ground.IA_BGC = IA_BGC_RichardsEqW_Xice();
        ...
        function timestep = get_timestep(ground, tile) 
            timestep_ground = get_timestep@GROUND_freezeC_RichardsEqW_Xice_seb_snow(ground, tile);
        ...
        function ground = compute_diagnostic_first_cell(ground, tile)
            ground = compute_diagnostic_first_cell@GROUND_freezeC_RichardsEqW_Xice_seb_snow(ground, tile);
