...
%             ia_BGC.GROUND.STATVAR.layerThick_wo_Xice(plus_LT) = ia_BGC.GROUND.STATVAR.layerThick_wo_Xice(plus_LT) + (water_change +  d_organic(plus_LT) + d_air) ./ ia_BGC.GROUND.STATVAR.area(plus_LT);
% 
%             
%             %minus_LT, layerThick decreases, air is pressed out, if no air
%             %available, waterIce is converted to XwaterIce  
...
%              ia_BGC.GROUND.STATVAR.layerThick_wo_Xice(minus_LT) = ia_BGC.GROUND.STATVAR.layerThick_wo_Xice(minus_LT) + (d_air + d_organic(minus_LT) - water_change) ./ ia_BGC.GROUND.STATVAR.area(minus_LT);
% 
%              %update organic
%              ia_BGC.GROUND.STATVAR.organic = ia_BGC.GROUND.STATVAR.organic + d_organic;
%             
