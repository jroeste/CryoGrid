...
classdef GROUND_freeW_bucketW_convection_seb_lwr < SEB & HEAT_CONDUCTION & WATER_FLUXES & HEAT_FLUXES_LATERAL & WATER_FLUXES_LATERAL & AIR_CONVECTION 
    ...
    methods
        ...
        function ground = provide_PARA(ground)
            ...
            % Gange med eef Longwave. med 0 er det ingen longwave. Teoretisk . Kanskje 0.5? [0,1]. Geometri forklaring, mellom 2 gridceller. 
            % Må gjennnom luft. 
        ...
        function ground = provide_STATVAR(ground)
            ...
            % NEED TO VARY THIS PARAMETER (grain_size). 1mm is like
...
%             ground.STATVAR.area = tile.PARA.area + ground.STATVAR.T .* 0;
        ...
        function ground = get_boundary_condition_u(ground, tile)
            ...
            % TODO: JR check if i need other boundary conditions?
        end
        ...
        function ground = get_derivatives_prognostic(ground, tile)
            ...
            % TODO: JR. Her legges endringene (ekstra energy due to longwave) inn. Bør forvente kaldere.
            %       Must define get_derivative_lwr(ground).
            % TODO_JRadd: ground = get_derivatete_longwave(ground) % Legge inn her 2isgma*t**4, 2, husk topp bunn. Ingen masseutvekslin
        end
